...
describe('StreamDeckGrid', () => {
  ...
  it('should display empty state when no keys are configured', () => {
    ...
    expect(screen.getByText('No keys configured. Click to add new keys.')).toBeInTheDocument()
  })
  ...
  it('should handle key click and play sound', () => {
    ...
    expect(mockStoreState.setSelectedKey).toHaveBeenCalledWith(mockStreamDeckKey)
  ...
  it('should handle key click without sound_id', () => {
    ...
    expect(mockStoreWithoutSound.setSelectedKey).toHaveBeenCalledWith(keyWithoutSound)
