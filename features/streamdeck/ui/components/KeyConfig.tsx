		...
		<Card className="h-full glassmorphism">
			...
			<CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-6">
				<div className="space-y-2">
					<Label htmlFor="sound" className="text-sm sm:text-base">
						Sound
					</Label>
					<Select
				...
				<div className="space-y-2">
					<Label htmlFor="hotkey" className="text-sm sm:text-base">
						Hotkey
					</Label>
					<Input
						id="hotkey"
					...
					<p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4">
						Format: use combinations like{' '}
						<code className="text-xs">ctrl+1</code>,{' '}
						<code className="text-xs">shift+a</code>,{' '}
						<code className="text-xs">alt+s</code>. All keys must be lowercase.
